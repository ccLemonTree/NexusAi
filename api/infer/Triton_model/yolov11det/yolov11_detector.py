...
from api.infer.Triton_model.yolov11det.utils.processing import *


def yolov11det(triton_client, service_name, init_data, img, label_to_detect,box_info, conf_thres=-1, iou_thres=-1,conf=None):
